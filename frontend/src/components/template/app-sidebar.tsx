...
export function AppSidebar() {
  ...
  return (
    <Sidebar collapsible="offcanvas" variant="sidebar" side="left" className="bg-sidebar">
      <SidebarHeader>
        <div className="text-sidebar-foreground/70 px-2 py-1 text-xs font-semibold uppercase tracking-wide">
          Navigation
        </div>
      </SidebarHeader>
      ...
      <SidebarFooter className="flex flex-col gap-2">
        ...
        <div className="text-sidebar-foreground/60 px-2 py-1 text-xs">
