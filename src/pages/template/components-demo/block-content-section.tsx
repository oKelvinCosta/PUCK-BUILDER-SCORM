            ...
            >
              ...
              <div className="mb-4 flex flex-wrap items-end gap-4">
                <div className="flex flex-col gap-1">
                  <label className="text-sm font-medium text-muted-foreground">Choose Image</label>
              ...
              <div className="mb-4 flex flex-wrap gap-6">
                ...
                {/* TITLE COLOR */}
                <div className="flex flex-col gap-1">
                  <label className="text-sm font-medium text-muted-foreground">Title Color</label>
                  <Select
                    value={b.titleColor}
